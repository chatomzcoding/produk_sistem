      ...
      <div class="row">
          ...
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">
                {{ DbSistem::countData('manajemen_jobdesk',['anggota_id',$anggota->id])}}
              </span>
            </div>
            <!-- /.info-box-content -->
          </div>
        ...
        <div class="col-12 col-sm-6 col-md-3">
          <div class="info-box mb-3">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">{{ DbSistem::countData('layanan')}}</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-12 col-sm-6 col-md-3">
          <div class="info-box mb-3">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Proyek yang diikuti</span>
              <span class="info-box-number">{{ DbSistem::countData('manajemen_proyek',['anggota_id',$anggota->id])}}</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-md-8">
                  <p class="text-center">
                    <strong>Bulan {{ bulan_indo(ambil_bulan())}}</strong>
                  </p>

                  <div class="chart">
                    <!-- Sales Chart Canvas -->
                    <figure class="highcharts-figure">
                        <div id="chart-jobdesk"></div>
                        <p class="highcharts-description">
                            Perkembangan jobdesk setiap hari
                        </p>
                    </figure>
                  </div>
                  <!-- /.chart-responsive -->
                ...
                <div class="col-md-4">
                  ...
                  @php
                      $jumlahproyek = DbSistem::countData('proyek');
                      $proyekdiikuti= DbSistem::countData('manajemen_proyek',['anggota_id',$anggota->id]);
                  @endphp
                  <div class="progress-group">
                    Proyek
                    <span class="float-right"><b>{{ $proyekdiikuti}}</b>/{{ $jumlahproyek}}</span>
                    <div class="progress progress-sm">
                      <div class="progress-bar bg-primary" style="width: {{ dashboard_persentase($proyekdiikuti,$jumlahproyek)}}%"></div>
                    </div>
                  </div>
                  <!-- /.progress-group -->
              ...
              <div class="row">
                <div class="col-sm-3 col-6">
                  <div class="description-block border-right">
                    ...
                    <h5 class="description-header">{{ rupiah(0)}}</h5>
                ...
                <div class="col-sm-3 col-6">
                  <div class="description-block border-right">
                    ...
                    <h5 class="description-header">{{ rupiah(0)}}</h5>
                    <span class="description-text">TOTAL TABUNGAN</span>
                  </div>
                  <!-- /.description-block -->
                </div>
                <!-- /.col -->
                ...
                <div class="col-sm-3 col-6">
                  <div class="description-block">
                    ...
                    <span class="description-text">Jobdesk Terselesaikan</span>
                  </div>
                  <!-- /.description-block -->
                </div>
              </div>
